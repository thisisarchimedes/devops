...
class ConfigLocal(Config):
    ...
    def get_expected_auth_token(self) -> str:
        token = os.getenv('DEVOPS_EVENTS_SECRET_TOKEN')
        if token is None:
            raise ValueError(
                "Environment variable 'DEVOPS_EVENTS_SECRET_TOKEN' is not set")
        return token
    ...
    def get_logger_api_key(self) -> str:
        ...
        if api_key is None:
            raise ValueError(
                "Environment variable 'LOGGER_API_KEY' is not set")
        return api_key
    ...
    def get_db_name(self) -> str:
        ...
        if db_name is None:
            raise ValueError(
                "Environment variable 'DEVOPS_DB_NAME' is not set")
        return db_name
    ...
    def get_db_table_name(self) -> str:
        ...
        if table_name is None:
            raise ValueError(
                "Environment variable 'DEVOPS_TABLE_NAME' is not set")
        return table_name
    ...
    def get_deployment_freq_timeframe_days(self) -> int:
        ...
        if timeframe is None:
            raise ValueError(
                "Environment variable 'DEPLOYMENT_FREQ_TIMEFRAME_DAY' is not set")
